...
| TemporaryRequestStorageMemcachedNodeEndPoint | Endpunkt zu einem Memcached-Knoten, in dem die Daten der Anforderungen vorübergehend gespeichert werden. Im Multi-Server-Modus muss dieser MemCached-Knoten für alle Knoten erreichbar sein. Wenn kein Wert angegeben ist (Standard), werden die Anforderungen basierend auf der TemporaryRequestStoragePath-Einstellung verwaltet. |
| TemporaryRequestStorageMemcachedConfigEndPoint | Endpunkt für eine Amazon ElastiCache-Clusterkonfiguration für einen Memcached-Knotenclusterknoten, in dem die Daten der Anforderungen vorübergehend gespeichert werden. Im Multi-Server-Modus muss dieser Memcached-Knoten für alle Knoten erreichbar sein. Wenn kein Wert angegeben ist (Standard), werden die Anforderungen basierend auf der TemporaryRequestStoragePath-Einstellung verwaltet. |
