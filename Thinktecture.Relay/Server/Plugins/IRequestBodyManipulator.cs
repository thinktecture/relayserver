...
{
	/// <summary>
	/// Interface for plugins that are capable of modifying the body of an incoming request before it gets relayed to its destination.
	/// </summary>
	public interface IRequestBodyManipulator
	{
		/// <summary>
		/// This method can replace the body of a request if it returns a new body to replace the old.
		/// </summary>
		...
		/// <returns>Return the new body that will replace the body on the provided <paramref name="request"/>.
