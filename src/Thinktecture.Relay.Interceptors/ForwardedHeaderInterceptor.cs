...
{
	public Task OnRequestReceivedAsync(IRelayContext<TRequest, TResponse> context,
		CancellationToken cancellationToken = default)
	{
		context.ClientRequest.HttpHeaders.Add("X-Forwarded-For",
			new[] { context.HttpContext.Connection.RemoteIpAddress.ToString() });
