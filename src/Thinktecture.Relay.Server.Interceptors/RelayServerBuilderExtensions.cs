...
public static class RelayServerBuilderExtensions
{
	...
	public static IRelayServerBuilder<TRequest, TResponse, TAcknowledge> AddForwardedHeaderInterceptor<TRequest,
	...
	{
		builder
			.AddClientRequestInterceptor<TRequest, TResponse, TAcknowledge,
				ForwardedHeaderInterceptor<TRequest, TResponse>>();
