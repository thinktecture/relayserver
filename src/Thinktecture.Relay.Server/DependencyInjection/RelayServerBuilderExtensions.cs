...
public static class RelayServerBuilderExtensions
{
	...
	public static IRelayServerBuilder<TRequest, TResponse, TAcknowledge> AddInMemoryServerTransport<TRequest, TResponse,
		TAcknowledge>(
	...
	{
		builder.Services
			.AddSingleton<IServerTransport<TResponse, TAcknowledge>, InMemoryServerTransport<TResponse, TAcknowledge>>();
	...
	public static IRelayServerBuilder<TRequest, TResponse, TAcknowledge> AddInMemoryBodyStore<TRequest, TResponse,
		TAcknowledge>(
		this IRelayServerBuilder<TRequest, TResponse, TAcknowledge> builder)
		where TRequest : IClientRequest
		where TResponse : ITargetResponse
	...
	public static IRelayServerBuilder<TRequest, TResponse, TAcknowledge> AddFileBodyStore<TRequest, TResponse,
		TAcknowledge>(
		this IRelayServerBuilder<TRequest, TResponse, TAcknowledge> builder,
		Action<FileBodyStoreOptions>? configure = null)
		where TRequest : IClientRequest
		where TResponse : ITargetResponse
		where TAcknowledge : IAcknowledgeRequest
	{
	...
	/// <typeparam name="TAcknowledge">The type of acknowledge.</typeparam>
	/// <returns>The <see cref="IRelayServerBuilder{TRequest,TResponse,TAcknowledge}"/> instance.</returns>
	public static IRelayServerBuilder<TRequest, TResponse, TAcknowledge> AddMaintenanceJobs<TRequest, TResponse,
		TAcknowledge>(
