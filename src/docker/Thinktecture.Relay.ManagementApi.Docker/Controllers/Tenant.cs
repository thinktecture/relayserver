...
{
	public static Tenant ToModel(this Server.Persistence.Models.Tenant tenant)
		=> new Tenant()
		{
			Id = tenant.Id,
			Name = tenant.Name,
	...
	public static async IAsyncEnumerable<Tenant> ToModels(
		this IAsyncEnumerable<Server.Persistence.Models.Tenant> tenants)
	{
	...
	public static Server.Persistence.Models.Tenant ToTenant(this Tenant tenant)
		=> new Server.Persistence.Models.Tenant()
		{
			Id = tenant.Id,
			Name = tenant.Name,
			DisplayName = tenant.DisplayName,
