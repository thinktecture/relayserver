...
{
	/// <summary>
	/// Gets the simple name of the assembly. This is usually, but not necessarily, the file name of the manifest file of the
	/// assembly, minus its extension.
	/// </summary>
	...
	/// <summary>
	/// Gets the version of the assembly either from the <see cref="AssemblyInformationalVersionAttribute"/> or
