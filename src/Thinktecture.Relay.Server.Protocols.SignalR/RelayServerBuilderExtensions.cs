...
public static class RelayServerBuilderExtensions
{
	...
	public static IRelayServerBuilder<TRequest, TResponse, TAcknowledge> AddSignalRConnectorTransport<TRequest,
		...
		where TAcknowledge : IAcknowledgeRequest
	{
		...
		builder.Services
			.AddSingleton<IConnectorTransportFactory<TRequest>,
				ConnectorTransportFactory<TRequest, TResponse, TAcknowledge>>();

		builder.Services.AddSingleton<IConnectorTransportLimit, ConnectorTransportLimit>();
		builder.Services
			.AddSingleton<IApplicationBuilderPart, ApplicationBuilderPart<TRequest, TResponse, TAcknowledge>>();
