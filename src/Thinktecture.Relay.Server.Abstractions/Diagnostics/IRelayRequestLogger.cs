	...
	where TResponse : class, ITargetResponse
{
	...
	Task LogSuccessAsync(IRelayContext<TRequest, TResponse> relayContext);
	...
	/// <param name="relayContext">An <see cref="IRelayContext{TRequest,TResponse}"/>.</param>
	/// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
	Task LogAbortAsync(IRelayContext<TRequest, TResponse> relayContext);
	...
	/// <param name="relayContext">An <see cref="IRelayContext{TRequest,TResponse}"/>.</param>
	/// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
	Task LogFailAsync(IRelayContext<TRequest, TResponse> relayContext);
	...
	/// <param name="relayContext">An <see cref="IRelayContext{TRequest,TResponse}"/>.</param>
	/// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
	Task LogExpiredAsync(IRelayContext<TRequest, TResponse> relayContext);
	...
	/// <param name="relayContext">An <see cref="IRelayContext{TRequest,TResponse}"/>.</param>
	/// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
	Task LogErrorAsync(IRelayContext<TRequest, TResponse> relayContext);
}
