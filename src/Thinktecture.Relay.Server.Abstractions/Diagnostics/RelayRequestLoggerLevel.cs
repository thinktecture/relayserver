...
public static class RelayRequestLoggerLevelExtensions
{
	...
	public static bool LogSucceeded(this RelayRequestLoggerLevel level)
		=> (level & RelayRequestLoggerLevel.Succeeded) != 0;
	...
	public static bool LogAborted(this RelayRequestLoggerLevel level)
		=> (level & RelayRequestLoggerLevel.Aborted) != 0;
	...
	public static bool LogFailed(this RelayRequestLoggerLevel level)
		=> (level & RelayRequestLoggerLevel.Failed) != 0;
	...
	public static bool LogExpired(this RelayRequestLoggerLevel level)
		=> (level & RelayRequestLoggerLevel.Expired) != 0;
	...
	public static bool LogErrored(this RelayRequestLoggerLevel level)
		=> (level & RelayRequestLoggerLevel.Errored) != 0;
}
