...
namespace Thinktecture.Relay.Server.Persistence.EntityFrameworkCore
{
	...
	public class ConnectionRepository : IConnectionRepository
	{
		...
		public ConnectionRepository(RelayDbContext dbContext) => _dbContext = dbContext ?? throw new ArgumentNullException(nameof(dbContext));

		/// <inheritdoc />
		public Task<bool> IsConnectionAvailableAsync(Guid tenantId) => _dbContext.Connections.AnyAsync(c => c.TenantId == tenantId);
	}
}
