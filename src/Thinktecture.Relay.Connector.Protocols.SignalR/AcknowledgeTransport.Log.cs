...
public partial class AcknowledgeTransport<T>
{
	...
	{
		[LoggerMessage(LoggerEventIds.AcknowledgeTransportTransportingAck, LogLevel.Trace,
		...
		[LoggerMessage(LoggerEventIds.AcknowledgeTransportErrorTransportingAck, LogLevel.Error,
