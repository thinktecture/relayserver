...
public partial class DiscoveryDocumentRetryPolicy
{
	...
	{
		[LoggerMessage(LoggingEventIds.DiscoveryDocumentRetryPolicyLogRetry, LogLevel.Information,
		...
		[LoggerMessage(LoggingEventIds.DiscoveryDocumentKeepingDefaults, LogLevel.Warning,
		...
		[LoggerMessage(LoggingEventIds.DiscoveryDocumentUsingDelays, LogLevel.Debug,
